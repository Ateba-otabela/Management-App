      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="#" class="rounded-md  px-3 py-2 text-sm font-medium text-white no-underline" aria-current="page">Dashboard</a>
            <a href=" {{route('Task_list')}} " class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white no-underline hover:bg-gray-900">Task List</a>
            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white no-underline hover:bg-gray-900">Add</a>
            ...
            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white no-underline hover:bg-gray-900">Calendar</a>
            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white no-underline hover:bg-gray-900">Calendars</a>
          </div>
        </div>
      </div>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6a3 3 0 1 1 6 0 3 3 0 0 1-6 0zM6 9a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm12 8a3 3 0 1 0-6 0 3 3 0 0 0 6 0zM6 21a3 3 0 1 1 6 0m-6 0h6m-6 0a3 3 0 1 0-6 0m18 0a3 3 0 1 0-6 0m6 0h-6" />
        ...
        <div class="relative ml-3">
          <div>
            <button type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              ...
              @if (Auth::user()->profile_picture)
                  <img class="size-8 rounded-full" src="{{ Storage::url(Auth::user()->profile_picture) }}" alt="profile_picture">
              @else
          ...
          <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
            ...
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 no-underline hover:underline" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</a>
            <form action="{{ route('logout') }}" method="post">
                @csrf
            <button type="submit" class="block px-4 py-2 text-sm text-gray-700 no-underline hover:underline" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
            </form>
